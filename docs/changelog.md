...
| Standing rigging inspection | Annually | — | Rod rigging, reported replaced **2012**. No rig inspection has ever been done — get one before going offshore |
| Keel bolt torque / keel seam | Haulout | — | Known trailing edge separation |
...
| Anchor windlass | Quick Eagle 12 V | — | 1400 W |
| Winches | Lewmar 54ST-2 ×2, 44ST-2 ×3, 44ST-2 electric ×1 | — | |
| Mainsail track | Tides Marine Strong Track | — | |
| Headsail furler | Profurl | — | |
| Mast / boom | Selden aluminum | — | Keel stepped, double spreader |
| Standing rigging | 1×19 stainless rod | — | Replaced 2012 |
...
| Instruments | TackTick MN-100-2 (depth/speed/wind); Robertson Dateline ×2 | — | Robertson displays dead |
| Compass | Ritchie 4" | — | Helm |
| EPIRB | ACR Global-Fix | — | Re-register under new ownership |
| AIS transponder | — | — | Confirm what is actually installed |
| House battery | 12 V 4-D AGM | — | |
| Start battery | 12 V Group 27 sealed lead acid | — | Needs terminal covers |
