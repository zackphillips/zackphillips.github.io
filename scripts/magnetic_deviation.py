...
def get_position_from_signalk(signalk_host: str, signalk_port: int) -> Optional[Tuple[float, float]]:
    """
...
def load_cached_declination(cache_file: str = "data/magnetic_declination_cache.json") -> Optional[float]:
    """
