# Makefile for the SensESP windlass/engine firmware.
# Wraps PlatformIO, which is pinned in pyproject.toml and run through uv.
...
.PHONY: setup
setup: check-uv sync ## Setup complete development environment
